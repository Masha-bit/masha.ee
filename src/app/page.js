   ...
   <div className='h-[100vh] sm:w-[100vw] w-[100%] relative scroll-smooth' ref={ref}>
    ...
    <section id='home' className='transition-all duration-75 ease-in-out'>
      ...
      style={{
        ...
        <br/>
        <p className='font-montserrat'>Welcome to this wormhole that is my brain.Explore my inner most thoughts[^_^]. Oh did i forget to mention, this is <span className='span font-rust'> MY PORTFOLIO PAGE </span></p>
      ...
      <div 
      id='right' 
      className='h-[100%] sm:hidden w-[35%] absolute right-0 bg-transparent' 
      style={{
    ...
    <section id='about2' className='sm:h-[auto] sm:w-[100vw] sm:flex sm:items-center h-[100vh] w-[100%] bg-[#B000FF] text-[#ffffff] p-[2rem] font-montserrat relative transition-all duration-75 ease-in-out'>
      ...
      <h3 className='font-rust text-[32px]'>Igniting Innovation, One Project at a Time</h3>
      <br />
      <br />

      <p className='w-[450px] sm:w-[auto] text-[16px]'>Welcome to my frontend developer portfolio, where I blend innovation, experimentation, and a touch of culinary magic. As a frontend alchemist, I have explored uncharted territories, diving into experimental projects that push the boundaries of web development. From captivating storytelling websites to cutting-edge web animations, I've honed my skills by constantly learning and evolving.
      <br />
      <br />
       One of my standout experiences was crafting a delightful food app, where I worked closely with a talented team to transform concepts into a mouthwatering reality. Through wireframing, prototyping, and pixel-perfect UI design, I ensured that the app was visually appetizing and intuitive. Seamlessly integrating with backend systems, I brought the app to life with smooth user flows and real-time order tracking, ensuring a hassle-free and satisfying experience for users.</p>
       </div>
       </aside>
